...
CREATE TABLE `users` (
  ...
  `role` enum('admin','inventory manager','procurement manager') NOT NULL,
  `created_on` datetime NOT NULL DEFAULT current_timestamp(),
  `updated_on` datetime DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
(3, 'Janeil', 'Gonzales', 'JGonzales', 'hashedpass3', 'inventory manager', '2024-11-24 22:18:14', NULL),
(4, 'Patricia', 'Santos', 'PSantos', 'hashedpass4', 'procurement manager', '2024-11-24 22:18:14', NULL);
